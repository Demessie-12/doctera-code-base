...
import { UpdateProductHook } from "../../Services/apiContributor";
...
function ProductEditing() {
  ...
  return (
    <div>
      <Link
        to="/control/product"
        className="mt-3 block w-fit rounded-xl bg-gray-900 px-2 py-1 text-DocOrange"
      >
        Back to Products
      </Link>
      <p className="mt-2 px-2 text-center text-xl font-semibold capitalize text-gray-400 md:text-2xl">
        Product:&nbsp;

...
function OrderList() {
  ...
  // if (filtered == "New")
  //   filteredData = allorders.filter((order) => order.status == "Waiting");
  // else if (filtered == "On going")
  //   filteredData = allorders.filter((order) => order.status == "On delivery");
  // else if (filtered == "Delivered")
  //   filteredData = allorders.filter((order) => order.status == "Delivered");
  // else if (filteredTime == "Today")
  //   filteredData = allorders.filter((order) => order.timeGap <= 1);
  // else if (filteredTime == "This week")
  //   filteredData = allorders.filter((order) => order.timeGap <= 7);
  // else if (filteredTime == "This month")
  //   filteredData = allorders.filter((order) => order.timeGap <= 30);

  let filteredData = allorders.filter(
    (order) =>

...
function PasswordEdit() {
  ...
  return (
    <div className="mx-auto flex w-fit justify-center text-center text-black">
      <Form
        method="POST"
      ...
      >
        ...
        <button className="mx-auto ml-5 mt-5 w-fit rounded-full bg-DocOrange px-3 py-1.5 text-black">
